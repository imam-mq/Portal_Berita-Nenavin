	...
	<body class="font-[Poppins] pb-[72px]">
		<nav id="Navbar" class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]">
			...
			<div class="relative">
				...
				<div id="menuDesktop" class="hidden lg:flex items-center gap-3">
					...
					<a href="<?php echo e(route('front.seller')); ?>" class="rounded-full p-[12px_22px] flex gap-[10px] font-bold transition-all duration-300 bg-yellow-400 text-black shadow-md hover:shadow-lg">
		...
		<section id="Featured" class="mt-[30px]">
			<div class="main-carousel w-full">
				<?php $__empty_1 = true; $__currentLoopData = $featured_articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				<div class="featured-news-card relative w-full h-[550px] sm:h-[450px] md:h-[400px] lg:h-[500px] flex shrink-0 overflow-hidden">
					<img src="<?php echo e(Storage::url($article->thumbnail)); ?>" class="thumbnail absolute w-full h-full object-cover" alt="icon" />
					...
					<div class="card-detail max-w-[1130px] w-full mx-auto flex flex-col md:flex-row items-end justify-between pb-10 px-4 sm:px-6 md:px-10 relative z-20">
						<div class="flex flex-col gap-[10px]">
							...
							<a href="<?php echo e(route('front.details', $article->slug)); ?>" class="font-bold text-2xl md:text-3xl lg:text-4xl leading-[30px] md:leading-[40px] text-white hover:underline transition-all duration-300">
								<?php echo e($article->name); ?>

							</a>
							<p class="text-white text-xs md:text-sm"><?php echo e($article->created_at->format('M D, Y')); ?> • <?php echo e($article->category->name); ?></p>
						</div>
		...
		<section id="Up-to-date" class="max-w-[1130px] mx-auto flex flex-col gap-6 mt-10 px-4">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<a href="<?php echo e(route('front.details', $article->slug)); ?>" class="card-news">
					<div class="rounded-2xl ring-1 ring-gray-200 p-6 flex flex-col gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300 bg-white shadow-md">
						...
						<div class="flex flex-col gap-2">
							<h3 class="font-bold text-lg"><?php echo e($article->name); ?></h3>
		...
		<section id="Best-authors" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			...
			<!-- <div class="grid grid-cols-6 gap-[30px]">
				...
				<a href="<?php echo e(route('front.author', $author->slug)); ?>" class="card-authors">
					<div class="rounded-[20px] border border-[#EEF0F7] p-[26px_20px] flex flex-col items-center gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300">
						...
						<div class="flex flex-col gap-1 text-center">
							<p class="font-semibold"><?php echo e($author->name); ?></p>
							<p class="text-sm leading-[21px] text-[#A3A6AE]"><?php echo e($author->articles?->count() ?? 0); ?> News</p>
						</div>
					</div>
				</a>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
			...
			<div class="flex flex-col gap-3 shrink-0 w-full sm:w-fit">
				<a href="<?php echo e($bannerads->link); ?>">
					<div class="w-full sm:w-[900px] h-auto flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden">
						<img src="<?php echo e(Storage::url($bannerads->thumbnail)); ?>" class="object-cover w-full h-full sm:h-[120px] aspect-[3/1]" alt="ads" />
					</div>
				</a>
		...
		<section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px] px-4">
			...
			<div class="flex flex-col sm:flex-row justify-between items-center h-fit gap-5">
				<div class="relative w-full md:h-[424px] flex flex-1 rounded-2xl overflow-hidden">
					<img src="<?php echo e(Storage::url($entertaiment_featured_articles->thumbnail)); ?>" class="absolute w-full h-full object-cover" alt="icon" />
					<div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10"></div>
					<div class="card-detail w-full flex items-end p-[20px] sm:p-[30px] relative z-20">
						<div class="flex flex-col gap-[10px]">
							...
							<a href="details.html" class="font-bold text-[20px] sm:text-[30px] leading-[26px] sm:leading-[36px] text-white hover:underline transition-all duration-300">
								<?php echo e($entertaiment_featured_articles->name); ?>

							</a>
							<p class="text-white text-sm sm:text-base"><?php echo e($entertaiment_featured_articles->created_at->format('M D, Y')); ?></p>
						</div>
					</div>
				</div>
				<div class="h-[300px] sm:h-[424px] w-full sm:w-1/2 px-4 sm:px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar">
					<div class="w-full sm:w-[455px] flex flex-col gap-5 shrink-0">
						<?php $__empty_1 = true; $__currentLoopData = $entertaiment_articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						<a href="<?php echo e(route('front.details', $article->slug)); ?>" class="card py-[2px]">
							<div class="rounded-[20px] border border-[#EEF0F7] p-[10px] sm:p-[14px] flex items-center gap-3 sm:gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300">
								...
								<div class="flex flex-col justify-center gap-[4px] sm:gap-[6px]">
									<h3 class="font-bold text-base sm:text-lg leading-[22px] sm:leading-[27px]"><?php echo e(substr($article->name, 0, 50)); ?>...</h3>
									<p class="text-sm leading-[21px] text-[#A3A6AE]"><?php echo e($article->created_at->format('M D, Y')); ?></p>
								</div>
							</div>
						</a>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
		...
		<section id="Latest-sports" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px] px-4">
			...
			<div class="flex flex-col sm:flex-row justify-between items-center h-fit gap-5">
				...
				<?php if($olahraga_featured_articles): ?>
				<div class="relative w-full md:h-[424px] flex flex-1 rounded-2xl overflow-hidden">
					<img src="<?php echo e(Storage::url($olahraga_featured_articles->thumbnail)); ?>" class="absolute w-full h-full object-cover" alt="icon" />
					<div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10"></div>
					<div class="card-detail w-full flex items-end p-[20px] sm:p-[30px] relative z-20">
						<div class="flex flex-col gap-[10px]">
							<p class="text-white text-sm sm:text-base">Featured</p>
							<a href="<?php echo e(route('front.details', $olahraga_featured_articles->slug)); ?>" class="font-bold text-[20px] sm:text-[30px] leading-[26px] sm:leading-[36px] text-white hover:underline transition-all duration-300">
								<?php echo e($olahraga_featured_articles->name); ?>

							</a>
							<p class="text-white text-sm sm:text-base"><?php echo e($olahraga_featured_articles->created_at->format('M d, Y')); ?></p>
						</div>
					</div>
				</div>
				<?php else: ?>
				...
				<div class="h-[300px] sm:h-[424px] w-full sm:w-1/2 px-4 sm:px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar">
					<div class="w-full sm:w-[455px] flex flex-col gap-5 shrink-0">
						<?php $__empty_1 = true; $__currentLoopData = $olahraga_articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						<a href="<?php echo e(route('front.details', $article->slug)); ?>" class="card py-[2px]">
							<div class="rounded-[20px] border border-[#EEF0F7] p-[10px] sm:p-[14px] flex items-center gap-3 sm:gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300">
								<div class="w-[90px] sm:w-[130px] h-[70px] sm:h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
									<img src="<?php echo e(Storage::url($article->thumbnail)); ?>" class="object-cover w-full h-full" alt="thumbnail" />
...
<script src="<?php echo e(asset('customjs/two-lines-text.js')); ?>"></script>
		...
		<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\belajarbaru\resources\views/front/index.blade.php ENDPATH**/ ?>