...
<body class="font-[Poppins] pb-[83px]">
				...
				<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<a href="<?php echo e(route('front.category', $item_category->slug)); ?>" 
						...
						<div class="w-5 h-5 flex shrink-0">
							<img src="<?php echo e(Storage::url($item_category->icon)); ?>" alt="icon" class="w-5 h-5">
						</div>
		...
		<section id="Category-result" class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px] px-4">
			<h1 class="text-3xl md:text-4xl leading-[40px] md:leading-[45px] font-bold text-center">
				Explore Our <br />
				<?php echo e($category->name); ?> News
			</h1>
			
			<div id="search-cards" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] md:gap-[30px] w-full">
				<?php $__empty_1 = true; $__currentLoopData = $category->news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					<a href="<?php echo e(route('front.details', $news->slug)); ?>" class="card w-full">
						<div class="flex flex-col gap-4 p-5 transition-all duration-300 ring-1 ring-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18] rounded-[15px] overflow-hidden bg-white">
							...
							<div class="thumbnail-container h-[180px] sm:h-[200px] relative rounded-[15px] overflow-hidden">
								<div class="badge absolute left-4 top-4 flex p-[6px_14px] bg-white rounded-full shadow-sm">
									<p class="text-xs leading-[16px] font-bold uppercase"><?php echo e($news->category->name); ?></p>
								</div>
								<img src="<?php echo e(Storage::url($news->thumbnail)); ?>" alt="thumbnail photo" class="w-full h-full object-cover" />
							</div>

							<!-- News Content -->
							<div class="flex flex-col gap-2">
								<h3 class="text-base sm:text-lg leading-[24px] sm:leading-[27px] font-bold">
									<?php echo e(substr($news->name, 0, 50)); ?>....
								</h3>
			...
			<div class="flex flex-col gap-3 shrink-0 w-full md:w-fit">
				<a href="<?php echo e($bannerads->link); ?>">
					<div class="w-full md:w-[950px] h-auto flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden">
						<img src="<?php echo e(Storage::url($bannerads->thumbnail)); ?>" class="object-contain w-full h-full" alt="ads" />
					</div>
				</a>
			</div>
		</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\belajarbaru\resources\views/front/category.blade.php ENDPATH**/ ?>